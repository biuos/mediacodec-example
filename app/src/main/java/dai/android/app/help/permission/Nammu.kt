...
object Nammu {
    ...
    fun init(context: Context) {
        sharedPreferences = context.getSharedPreferences("dai.android.app.runtime.permission", Context.MODE_PRIVATE)
    ...
    fun shouldShowRequestPermissionRationale(fragment: Fragment, permissions: String): Boolean {
        return fragment.shouldShowRequestPermissionRationale(permissions)
    }

    fun shouldShowRequestPermissionRationale(fragment: android.app.Fragment, permissions: String): Boolean {
    ...
    fun isIgnoredPermission(permission: String?): Boolean {
        ...
        return ignoredPermissions.contains(permission)
    }
