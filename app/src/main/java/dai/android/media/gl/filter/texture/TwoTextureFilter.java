...
import dai.android.media.gl.canvas.TextureMatrixTransformer;
import dai.android.media.gl.view.texture.GLTexture;

import static dai.android.media.gl.matrix.BaseBitmapMatrix.MATRIX_SIZE;
